...
def output_logger(fld):
    ...
    name_2 = trustfile_contents[-2]['name']
    competence_2 = trustfile_contents[-2]['competence']
    willingness_2 = trustfile_contents[-2]['willingness']
    task_2 = trustfile_contents[-2]['task']
